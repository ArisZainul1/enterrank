...
{"topics": ["topic 1", "topic 2", ...]}`;
  ...
  return(<div style={{maxWidth:620,margin:"0 auto"}}>
    ...
    <div style={{marginTop:20,paddingTop:18,borderTop:`1px solid ${C.borderSoft}`,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
      <div style={{display:"flex",gap:12,alignItems:"center",opacity:fieldsLocked?0.4:1,transition:"opacity .3s ease"}}><span style={{fontSize:11,color:C.muted}}>Engines:</span><ChatGPTLogo size={18}/><GeminiLogo size={18}/><svg width="18" height="18" viewBox="0 0 16 16" fill="none"><path d="M8 0L14 4V12L8 16L2 12V4L8 0Z" fill="#20808D"/><path d="M8 3L11.5 5.5V10.5L8 13L4.5 10.5V5.5L8 3Z" fill="white" opacity="0.9"/></svg><div style={{display:"flex",alignItems:"center",gap:6,padding:"6px 12px",background:"#EA433510",borderRadius:8,border:"1px solid #EA433520"}}><svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="8" r="7" fill="#EA4335" opacity="0.15"/><text x="8" y="11" textAnchor="middle" fontSize="8" fontWeight="bold" fill="#EA4335">G</text></svg><span style={{fontSize:12,fontWeight:500,color:"#EA4335"}}>Google AI</span></div></div>
